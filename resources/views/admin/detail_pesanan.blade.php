            ...
            if ($nota->time_status == 'run'){
              ...
              if (strtotime($date_now) > strtotime($time_date)){
                ...
                if (strtotime($time_now) > strtotime($time_expired)){
                  ...
                  <div class="badge badge-success" id="btn_play_{{$nota->id}}" onclick='control_time("{{$nota->id}}", "start")' style="margin-left: 0.5em; margin-top: 0.5em;" hidden>
              ...
              <div class="badge badge-success" id="btn_play_{{$nota->id}}" onclick='control_time("{{$nota->id}}", "start")' style="margin-left: 0.5em; margin-top: 0.5em;">
                <i class="fas fa-play" style="font-size: 0.8em;"></i>&nbsp;&nbsp;Start
              </div>
            <?php } ?>
          </div>
        ...
        <div class="card-body">
          <table class="table" >
            <thead>
              <th>No.</th>
              <th style="">Produk                       
                <button onclick="show_modal_tambah_pesanan('{{$nota->id}}');" class="btn btn-warning">
                  tambah pesanan
                </button>
              </th>
