...
<div class="content-wrapper">
              ...
              <div class="timeline-item">
                <div class="timeline-header" style="display: flex; justify-content: space-between;">
                  <div style="display: flex; align-items: flex-start;">
                    ...
                    <h4  id="pause_countdown_{{$data->id_pesanan}}" style="color: red" hidden>{{$time_left}}</h4>
                    <div class="btn btn-primary" onclick='control_time("{{$data->id_pesanan}}")' style="padding: 0px 10px 3px 10px; margin-left: 0.5em;">Pause</div>
                    <script type="text/javascript">
                      <?php
                      ...
                      id_pesanan[{{$loop->iteration}}] = "{{$data->id_pesanan}}";
                      ...
                      function countdown(minutes, seconds, loop) {
                        function tick(){
                          ...
                          counter[loop].innerHTML =
                          minutes.toString() + ":" + (seconds < 10 ? "0" : "") + String(seconds);
                          seconds--;
                          if (seconds >= 0) {
                            timeoutHandle[loop] = setTimeout(tick, 1000);
                              console.log(loop+" = "+minutes+" menit : "+seconds+" detik");
  ...
  @section('footer')
  <script type="text/javascript">
    function control_time(id_pesanan){
