                ...
                <div class="timeline-header" style="display: flex; justify-content: space-between;">
                  <div style="display: flex; align-items: flex-start;">
                    ...
                    <script type="text/javascript">
                      ...
                      countdown(menit[{{$loop->iteration}}], detik[{{$loop->iteration}}]);

                      function countdown(minutes, seconds) {
                        function tick(){
                          counter[{{$loop->iteration}}] = document.getElementById("countdown_{{$data->id_pesanan}}");
                          counter[{{$loop->iteration}}].innerHTML =
                          ...
                          if (seconds >= 0) {
                            ...
                            if (minutes >= 1) {
                              setTimeout(function () {countdown(minutes - 1, 59);}, 1000);
                            }
                          }
                        }
                        tick();
