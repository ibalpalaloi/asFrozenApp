  ...
  <div class="card-body">
    ...
    <table class="table">
      <tbody>
        ...
        <td style="width: 30%; display: -webkit-box;display: flex;">
         <div style="margin-right: 1em; margin-top: 0.5em;" hidden>{{$qrcode->size(80)->generate(url('/')."/cetak-nota/pesanan/".$riwayat_nota->id_pesanan)}}</div>
